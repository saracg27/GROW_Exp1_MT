### DE analysis for D42
### Run on the cluster using de_D42.sh from the code folder: sbatch de_D42.sh
...
#histogram_raw <- hist(countData$`25-Mesocosm-1-1-Exp1-D42-Sed`, br = 100)

## Log2 transform and visualize
logCountData = log2(1 + countData)
#histogram_log <- hist(logCountData$`25-Mesocosm-1-1-Exp1-D42-Sed`, br = 50)
...
save.image(file = here("output", "DE_D42.RData"))
saveRDS(dds, file = here("output", "dds_D42.rds" ))
