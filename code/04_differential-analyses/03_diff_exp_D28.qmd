...
```{r}
countData1 <- countData[rowSums(countData) > 10,] # Down from 26M genes to 2 411 664 genes (2.41M)
rm(countData) # erase when finished if memory needed
```
